...
win32:LIBS += $$top_builddir/components/$(OBJECTS_DIR)/components.lib
linux:LIBS += $$top_builddir/components/$(OBJECTS_DIR)/libcomponents.a
INCLUDEPATH += $$top_srcdir/components/
TARGET = examples-exe
win32:PRE_TARGETDEPS += $$top_builddir/components/$(OBJECTS_DIR)/components.lib
linux:PRE_TARGETDEPS += $$top_builddir/components/$(OBJECTS_DIR)/libcomponents.a
